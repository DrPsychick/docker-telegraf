...
func main() {
	...
	if conf_file == "" || prefix == "" {
	    if debug { fmt.Println("No CONF_UPDATE or CONF_PREFIX defined - exiting.") }
		os.Exit(0)
	}
	...
	if debug { fmt.Println(string(str)) }
